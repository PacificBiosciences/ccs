    ...
    , start_{start}
{
    assert(Type == MutationType::DELETION ||
           Type == MutationType::ANY_INSERTION ||
...
{
    return Type == MutationType::INSERTION;
}

bool Mutation::IsSubstitution() const
{
    return Type == MutationType::SUBSTITUTION;
}

bool Mutation::IsAnyInsertion() const
{
    return Type == MutationType::ANY_INSERTION;
}

bool Mutation::IsAnySubstitution() const
{
    return Type == MutationType::ANY_SUBSTITUTION;
}
...
std::ostream& operator<<(std::ostream& out, const MutationType type)
{
    out << "MutationType::";
    switch (type) {
    case MutationType::DELETION: out << "DELETION"; break;
    case MutationType::INSERTION: out << "INSERTION"; break;
    case MutationType::SUBSTITUTION: out << "SUBSTITUTION"; break;
    case MutationType::ANY_INSERTION: out << "ANY_INSERTION"; break;
    case MutationType::ANY_SUBSTITUTION: out << "ANY_SUBSTITUTION"; break;
    default: throw std::invalid_argument("invalid MutationType");
    }
    return out;
}
