...
double SP1C1NoCovParams[8][4] =
    { // Match, Branch, Stick, Delete
        {0.893, 0.022, 0.038, 0.047}, // AA
        {0.831, 0.044, 0.077, 0.048}, // CC
        {0.886, 0.043, 0.038, 0.032}, // GG
        {0.832, 0.067, 0.063, 0.038}, // TT
        {0.826, 0.068, 0.074, 0.031}, // NA
        {0.856, 0.023, 0.052, 0.068}, // NC
        {0.854, 0.047, 0.056, 0.044}, // NT
        {0.892, 0.037, 0.043, 0.028}, // NG
    };
...
double SP1C1NoCovModel::BaseEmissionPr(MoveType move, const char from, const char to) const
{
    ...
    constexpr double pr = 0.04405555;
